...
async def start(client, message):
    ...
    text = "**Hey Nanthan vikki oda bot link anupuna download panni tharuven , 👋🏼 It's Colab Leecher**\n\n◲ Ipothaiku testing la irukken 🚀\n◲ Koodiya seikaram stable a varuven download panitu nalla iruntha Gpay pannu  🚀"
